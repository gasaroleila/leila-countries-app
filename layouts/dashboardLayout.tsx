    ...
    return (
        <div className={`${darkTheme ? "dark" : ""} w-screen h-screen`}>
            <nav className="bg-light dark:bg-element-dark w-full flex justify-between items-center h-14 text-black shadow-sm">
                <h1 className="font-bold ml-14 text-[17px] dark:text-light">Where in the world?</h1>
                <div className="flex items-center mr-20 cursor-pointer" onClick={toggleDarkTheme}>
